...
def _read_table(csv_filepath):
    ...
    df['PLACE'] = df['PLACE'].map(_normalize_str)
...
class SantaFeAPI:
    def __init__(self,work_dir):
        ...
        # Load CSV's
        self.df_info = _read_table(os.path.join("Info.csv"))
        self.df_confirmados = _read_table(os.path.join('Confirmados.csv'))
        self.df_descartados = _read_table(os.path.join('Descartados.csv'))
        self.df_sospechosos = _read_table(os.path.join('Sospechosos.csv'))
